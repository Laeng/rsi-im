...
import LaravelLogo from '@/views/components/logo/laravel-logo.vue'
import InertiaLogo from '@/views/components/logo/inertia-logo.vue'
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-zinc-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <Link :href="route('login')" class="ml-4 underline">
                            Login
                            </Link>
                        </div>
                    </div>
