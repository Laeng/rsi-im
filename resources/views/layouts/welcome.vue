...
<template>
    <basic-layout>
        <div class="grid grid-cols-1 lg:grid-cols-5">
            <aside class="lg:col-span-2 lg:flex lg:items-center lg:justify-end lg:h-screen lg:shadow-2xl lg:bg-[#273247] dark:lg:bg-[#1B2435]">
                <div class="xl:w-2/3 2xl:w-1/2 space-y-6 lg:p-16">
                    <rsi-im-logo class="fill-current h-12 w-auto" color-one="#6366f1" color-two="#72A1E0"/>
                    <div class="space-y-2">
                        <p class="text-gray-300">
                            본 서비스를 통해 Star Citizen® 및 Squadron 42®와 관련된 다양한 서비스에서 여러분의 RSI 계정으로 간편하게 인증할 수 있습니다.
                        </p>
            ...
            <main class="lg:col-span-3 block lg:flex lg:h-screen lg:justify-start lg:overflow-auto">
                <slot/>
            </main>
        </div>
    </basic-layout>
